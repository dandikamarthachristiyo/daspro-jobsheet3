...
public class Kafe07 {
  public static void main(String[] args) {
    ...
    double hargaKopi = 12000.0, hargaTeh = 7000.0, hargaRoti = 20000;
    float diskon = 10 / 100f;
    double totalHarga, nominalHarga;
    ...
    nominalHarga = totalHarga - (diskon * totalHarga);

    System.out.println("Keanggotaan pelanggan " + keanggotaan);
    System.out.println("Item pembelian " + jmlKopi + " kopi, " + jmlTeh + " teh, " + jmlRoti + " roti ");
    System.out.println("Nominal bayar Rp " + nominalHarga);
